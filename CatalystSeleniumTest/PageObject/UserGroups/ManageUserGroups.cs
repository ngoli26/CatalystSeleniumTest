...
namespace CatalystSelenium.PageObject.UserGroups
{
    public class ManageUserGroups : PageBase
    {
        ...
        private IWebElement AddtoGroupbutton;

        [FindsBy(How = How.XPath, Using = "Group Members")]
        private IWebElement GroupMembers;

        [FindsBy(How = How.XPath, Using = "//button[text()='Save']")]
        private IWebElement SaveUserGroup;
        ...
        public void UsergroupsValidateElements()
        {

            Assert.IsTrue(GenericHelper.IsElementPresentQuick(GetLocatorOfWebElement("GroupName")), "GroupName Element Not Found");
            Assert.IsTrue(GenericHelper.IsElementPresentQuick(GetLocatorOfWebElement("AddtoGroupbutton")), "AddtoGroupbutton Element Not Found");
           // Assert.IsTrue(GenericHelper.IsElementPresentQuick(GetLocatorOfWebElement("GroupMembers")), "GroupMembers Element Not Found");

            Assert.IsTrue(GenericHelper.IsElementPresentQuick(GetLocatorOfWebElement("SaveUserGroup")), "SaveUserGroup Element Not Found");
